...
import com.forestmonitoring.application.AppController;
...
public class VolleyTaskManager extends ServiceConnector {
	...
	/**
	 * Service method calling for Project Type -->
	 **/
	
	public void doGetProjectType(boolean isToHideDialog) {
		this.isToHideDialog = isToHideDialog;
		String url = getBaseURL() + "projectselection/projectType/get";
	...
	/**
	 * Service method calling for Project -->
	 **/
	
	public void doGetProject(boolean isToHideDialog,String params) {
		this.isToHideDialog = isToHideDialog;
		String url = getBaseURL() + "projectselection/project/get?"+params;
		int method = Method.GET;
	...
	/**
	 * Service method calling for Sub Project -->
	 **/
	
	public void doGetSubProject(boolean isToHideDialog,String params) {
		this.isToHideDialog = isToHideDialog;
		String url = getBaseURL() + "projectselection/Subproject/get?"+params;
		int method = Method.GET;
